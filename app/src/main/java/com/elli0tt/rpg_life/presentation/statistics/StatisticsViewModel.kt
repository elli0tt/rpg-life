...
class StatisticsViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val getSkillsStatisticsPieEntriesUseCase: GetSkillsStatisticsPieEntriesUseCase = GetSkillsStatisticsPieEntriesUseCase(skillsRepository)
    ...
    private val skillsPieData: LiveData<PieData>
            = Transformations.map(getSkillsStatisticsPieEntriesUseCase.invoke()){ pieEntries ->
